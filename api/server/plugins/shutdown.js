...
const gracefulShutdown = (server) => {
  ...
  if (server.settings.app.env !== 'test') {
    console.log(Chalk.bgBlack.green('Shutting down...'));
  }

  server.jobs && server.jobs.stop(() => {

    if (server.settings.app.env !== 'test') {
      console.log(Chalk.bgBlack.green('Shutting down job queue...'));
    }
...
exports.register = (server, options, next) => {
  ...
  if (server.settings.app.env !== 'test') {
    console.log(Chalk.bgBlack.green('Registering shutdown cleanup...'));
  }
